...
const translations = {
  en: {
    ...
    auth: {
      ...
      duplicateUsername: "This username is already taken. Please choose another one.",
      ...
      checkingCredentials: "Checking your username and password...",
      creatingAccount: "Creating your account securely...",
      authUnavailable: "Secure authentication is unavailable in this browser. Please try again in a modern browser.",
